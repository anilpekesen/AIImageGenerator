  ...
  return (
    <Page title={t("dashboard.pageTitle")}>
      <Layout>
        ...
        {/* Value proposition section — FolioAI inspired */}
        <Layout.Section>
          <Card>
            <BlockStack gap="500">
              <BlockStack gap="150" inlineAlign="center">
                <Text as="h2" variant="headingLg" alignment="center">
                  {t("dashboard.valueSection.heading")}
                </Text>
                <Text as="p" tone="subdued" alignment="center">
                  {t("dashboard.valueSection.subheading")}
                </Text>
              </BlockStack>
                  ...
                  <div key={key} style={{
                    ...
                    <BlockStack gap="300">
                      ...
                      <Text as="h3" variant="headingSm" fontWeight="bold">
                        {t(`dashboard.valueSection.${key}.title`)}
                      </Text>
                      <Text as="p" tone="subdued" variant="bodySm">
                        {t(`dashboard.valueSection.${key}.desc`)}
                      </Text>
                    </BlockStack>
                  </div>
                ))}
              ...
              <div style={{ textAlign: "center" }}>
                <Button variant="primary" size="large" onClick={() => navigate("/app/generate")} disabled={remaining <= 0}>
                  {t("dashboard.valueSection.cta")}
                </Button>
              </div>
            </BlockStack>
          </Card>
